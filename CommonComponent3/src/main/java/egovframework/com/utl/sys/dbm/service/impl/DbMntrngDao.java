...
public class DbMntrngDao extends EgovComAbstractDAO {
	...
	public DbMntrng selectDbMntrng(DbMntrng dbMntrng)
	  throws Exception{
		return (DbMntrng)selectByPk("DbMntrngDao.selectDbMntrng", dbMntrng);
	}
	...
	public DbMntrngLog selectDbMntrngLog(DbMntrngLog dbMntrngLog)
	  throws Exception{
		return (DbMntrngLog)selectByPk("DbMntrngDao.selectDbMntrngLog", dbMntrngLog);
	}
	...
	public List<DbMntrng> selectDbMntrngList(DbMntrng searchVO)
	  throws Exception{
		return (List<DbMntrng>) list("DbMntrngDao.selectDbMntrngList", searchVO);
	}
	...
	public int selectDbMntrngListCnt(DbMntrng searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DbMntrngDao.selectDbMntrngListCnt", searchVO);
	}
	...
	public List<DbMntrngLog> selectDbMntrngLogList(DbMntrngLog searchVO)
	  throws Exception{
		return (List<DbMntrngLog>) list("DbMntrngDao.selectDbMntrngLogList", searchVO);
	}
	...
	public int selectDbMntrngLogListCnt(DbMntrngLog searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DbMntrngDao.selectDbMntrngLogListCnt", searchVO);
	}
