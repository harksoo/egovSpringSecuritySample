...
public class ReprtStatsDAO extends EgovComAbstractDAO {
    ...
    public int selectReprtStatsListTotCnt(ReprtStatsVO reprtStatsVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("reprtStatsDAO.selectReprtStatsListTotCnt", reprtStatsVO);
    }
    ...
    public int selectReprtStatsListBarTotCnt(ReprtStatsVO reprtStatsVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("reprtStatsDAO.selectReprtStatsListBarTotCnt", reprtStatsVO);
    }    
