...
public class DeptAuthorDAO extends EgovComAbstractDAO {
	...
	public int selectDeptAuthorListTotCnt(DeptAuthorVO deptAuthorVO) throws Exception {
		return (Integer)getSqlMapClientTemplate().queryForObject("deptAuthorDAO.selectDeptAuthorListTotCnt", deptAuthorVO);
	}
	...
	public int selectDeptListTotCnt(DeptAuthorVO deptAuthorVO) throws Exception {
		return (Integer)getSqlMapClientTemplate().queryForObject("deptAuthorDAO.selectDeptListTotCnt", deptAuthorVO);
	}	
}