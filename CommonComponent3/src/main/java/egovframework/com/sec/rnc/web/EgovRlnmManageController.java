...
public class EgovRlnmManageController {
    ...
    public String rlnmCnfirm(Model model, @CommandMap Map<String, Object> commandMap) throws Exception {
    ...
    public String rlnmPinCnfirm(Model model, @CommandMap Map<String, Object> commandMap, HttpServletRequest request) throws Exception {
        model.addAttribute("sbscrbTy", 		(String)commandMap.get("sbscrbTy"));     //사용자유형
    	model.addAttribute("nextUrlName", (String)commandMap.get("nextUrlName")); //다음단계버튼명(이동할 URL에 따른)
    	model.addAttribute("nextUrl",     (String)commandMap.get("nextUrl"));     //다음단계로 이동할 URL
...
log.debug("realName:"+realName);
    ...
    public String gpinCall(Model model, @CommandMap Map<String, Object> commandMap) throws Exception {
