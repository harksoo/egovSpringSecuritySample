...
public class EntrprsManageDAO extends EgovComAbstractDAO{
    ...
    public EntrprsManageVO selectEntrprsmber(String entrprsmberId){
        return (EntrprsManageVO) selectByPk("entrprsManageDAO.selectEntrprs_S", entrprsmberId);
    }
    ...
    public EntrprsManageVO selectPassword(EntrprsManageVO entrprsManageVO){
    	return (EntrprsManageVO) selectByPk("entrprsManageDAO.selectPassword_S", entrprsManageVO);
    }
    ...
    public int selectEntrprsMberListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("entrprsManageDAO.selectEntrprsMberListTotCnt", userSearchVO);
    }
}