...
public class IndvdlPgeDAO extends EgovComAbstractDAO {
	...
	private static final Logger LOG = Logger.getLogger(IndvdlPgeDAO.class.getName());
	...
	public IndvdlPgeVO selectIndvdlpgeResult(IndvdlPgeVO indvdlPgeVO){
		return (IndvdlPgeVO)selectByPk("IndvdlPgeDAO.selectIndvdlpgeResult", indvdlPgeVO);
	}*/
	...
	public IndvdlPge selectIndvdlpgeCntnts(IndvdlPge indvdlPge){
		return (IndvdlPge)selectByPk("IndvdlPgeDAO.selectIndvdlpgeCntnts", indvdlPge);		 
	}
	...
	public int selectIndvdlpgeCntntsListTotCnt(IndvdlPgeCntntsVO indvdlPgeCntntsVO){
		return (Integer)getSqlMapClientTemplate().queryForObject("IndvdlPgeDAO.selectIndvdlpgeListTotCnt", indvdlPgeCntntsVO);
	}
	...
	public int selectIndvdlpgeAddCntntsListTotCnt(IndvdlPgeCntntsVO indvdlPgeCntntsVO){
		return (Integer)getSqlMapClientTemplate().queryForObject("IndvdlPgeDAO.selectIndvdlpgeAddListTotCnt", indvdlPgeCntntsVO);
	}
	...
	public int selectIndvdlpgeResultCnt(IndvdlPgeVO indvdlPgeVO){
		return (Integer)getSqlMapClientTemplate().queryForObject("IndvdlPgeDAO.selectIndvdlpgeConfCnt", indvdlPgeVO);
	}
	...
	public int selectIndvdlpgeResultTotCnt(IndvdlPgeVO indvdlPgeVO) throws Exception {
		return (Integer)getSqlMapClientTemplate().queryForObject("IndvdlPgeDAO.selectIndvdlpgeResultTotCnt", indvdlPgeVO);
	}	
	...
	public int selectIndvdlpgeResultDetailTotCnt(IndvdlPgeVO indvdlPgeVO) throws Exception {
		return (Integer)getSqlMapClientTemplate().queryForObject("IndvdlPgeDAO.selectIndvdlpgeResultDetailTotCnt", indvdlPgeVO);
	}		
