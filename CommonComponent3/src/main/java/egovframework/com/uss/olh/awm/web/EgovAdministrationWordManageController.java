...
public class EgovAdministrationWordManageController {
    ...
    public String egovAdministrationWordManageDetail(
            ...
            AdministrationWordManage administrationWordManage, @CommandMap Map commandMap,
    ...
    public String egovAdministrationWordManageModify(
        ...
        if (sCmd.equals("save")) {
            ...
            //아이디 설정
            administrationWordManage.setFrstRegisterId((String)loginVO.getUniqId());
            administrationWordManage.setLastUpdusrId((String)loginVO.getUniqId());
