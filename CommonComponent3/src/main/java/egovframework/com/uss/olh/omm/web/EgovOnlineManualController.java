...
public class EgovOnlineManualController {
    ...
    public String egovOnlineManualUserDetail(
            ...
            OnlineManual onlineManual, @CommandMap Map commandMap,
            ModelMap model) throws Exception {
    ...
    public String egovOnlineManualModify(
        ...
        if (sCmd.equals("save")) {
            ...
            //아이디 설정
            onlineManual.setFrstRegisterId((String)loginVO.getUniqId());
            onlineManual.setLastUpdusrId((String)loginVO.getUniqId());
