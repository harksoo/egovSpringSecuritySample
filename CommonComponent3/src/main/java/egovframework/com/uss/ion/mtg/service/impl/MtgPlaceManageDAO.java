...
public class MtgPlaceManageDAO extends EgovComAbstractDAO {
	...
	public MtgPlaceManageVO selectMtgPlaceResve(MtgPlaceManageVO mtgPlaceManageVO)  throws Exception {
		return (MtgPlaceManageVO) selectByPk("mtgPlaceManageDAO.selectMtgPlaceResve", mtgPlaceManageVO);
	}
	 ...
	 * @param mtgPlaceManage - 회의실관리 model
	 */
	public void deleteMtgPlaceFxtrs(MtgPlaceFxtrs mtgPlaceFxtrs) throws Exception {
		insert("mtgPlaceManageDAO.deleteMtgPlaceFxtrs", mtgPlaceFxtrs);
	}
