...
public class EgovUnityLinkController {
    ...
    public String egovUnityLinkList(
        ...
        int totCnt = (Integer) egovUnityLinkService.selectUnityLinkListCnt(searchVO);
    ...
    public String egovUnityLinkDetail(
            ...
            UnityLink unityLink, @CommandMap Map commandMap,
    ...
    public String egovUnityLinkRegist(
        ...
        String sLocationUrl = "egovframework/com/uss/ion/ulm/EgovUnityLinkRegist";
