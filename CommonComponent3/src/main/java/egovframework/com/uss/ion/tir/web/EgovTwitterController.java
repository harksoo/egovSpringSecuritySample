...
public class EgovTwitterController {
    ...
    public String EgovTwitterAccountGet(ModelMap model) throws Exception {
    	...
    	HashMap hmPram = new HashMap();
    	hmPram.put("usid", (String)loginVO.getUniqId());

    	Map mapResult = (Map)egovTwitterTrnsmitService.selectTwitterAccount(hmPram);
    ...
    public String EgovTwitterPopupPost(@CommandMap Map commandMap, ModelMap model) throws Exception {
