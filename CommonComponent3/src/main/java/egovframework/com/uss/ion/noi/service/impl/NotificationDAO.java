...
public class NotificationDAO extends EgovComAbstractDAO {
	...
	return (List<NotificationVO>) list("NotificationDAO.selectNotificationInfs", vo);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("NotificationDAO.selectNotificationInfsCnt", vo);
    }
	...
	return (String)insert("NotificationDAO.insertNotificationInf", notification);
    }
	...
	return (NotificationVO)selectByPk("NotificationDAO.selectNotificationInf", searchVO);
    }
	...
	return (List<NotificationVO>) list("NotificationDAO.getNotificationData", vo);
    }
}
