...
public class EgovMtgPlaceManageController {
    ...
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceManage.do")
	 public String selectMtgPlaceManage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
									    @ModelAttribute("mtgPlaceManage") MtgPlaceManage mtgPlaceManage,
										@ModelAttribute("MtgPlaceFxtrsVO") MtgPlaceFxtrsVO mtgPlaceFxtrsVO,
        ...
        mtgPlaceFxtrsVO.setMtgPlaceId(mtgPlaceManage.getMtgPlaceId());
        mtgPlaceFxtrsVO.setMtgPlaceFxtrsList(egovMtgPlaceManageService.selectFxtrsManageList(mtgPlaceFxtrsVO));
        model.addAttribute("lcSeCode",          lcSeCodeList);
		model.addAttribute("mtgPlaceFxtrsList", mtgPlaceFxtrsVO.getMtgPlaceFxtrsList());  	
    ...
    @RequestMapping(value="/uss/ion/mtg/insertMtgPlace.do")
	 public String insertMtgPlaceManage(final MultipartHttpServletRequest multiRequest,
			                            @RequestParam("checkedMtgPlacesForInsert") String checkedMtgPlacesForInsert ,
			 							@ModelAttribute("mtgPlaceManage") MtgPlaceManage mtgPlaceManage,
			                            @ModelAttribute("MtgPlaceFxtrs") MtgPlaceFxtrs mtgPlaceFxtrs,
			                            @ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
			                            BindingResult bindingResult,
    	...
    	if (bindingResult.hasErrors()) { 
	    	...
	    	status.setComplete();
	    	egovMtgPlaceManageService.insertMtgPlaceManage(mtgPlaceManage, checkedMtgPlacesForInsert, mtgPlaceManageVO);
    ...
    @SuppressWarnings("unchecked")
	 ...
	 public String updateMtgPlaceManage(final MultipartHttpServletRequest multiRequest,
    	...
    	if (bindingResult.hasErrors()) { 
	    	...
	    	status.setComplete();
	    	egovMtgPlaceManageService.updtMtgPlaceManage(mtgPlaceManage, checkedMtgPlacesForInsert, mtgPlaceManageVO);
	    	model.addAttribute("message", egovMessageSource.getMessage("success.common.insert"));
...
*/
	 ...
	 */
	 ...
	 public String selectMtgPlaceResveManage(	@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		mtgPlaceManageVO_Temp.setMtgPlaceTemp4(loginVO.getName());
		mtgPlaceManageVO_Temp.setMtgPlaceTemp5(loginVO.getOrgnztNm());	    	
    	model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
	 ...
	 */
	 ...
	 public String selectMtgPlaceResveManageDetail(	@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		if(sCmd.equals("detail")){
			LoginVO loginVO = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
    		mtgPlaceManageVO_Temp.setUsidTemp(loginVO.getUniqId());
	 ...
	 */
	 ...
	 public String insertMtgPlaceResveManage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
    	...
    	if (bindingResult.hasErrors()) { 
	    	...
	    	status.setComplete();
	    	model.addAttribute("message", egovMessageSource.getMessage("success.common.insert"));
	    	mtgPlaceResve.setResveManId(user.getUniqId());
	    	mtgPlaceResve.setFrstRegisterId(user.getUniqId());
