...
public class BndtManageDAO extends EgovComAbstractDAO {
    ...
    public int selectBndtDiaryTotCnt(BndtManage bndtManage) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("bndtManageDAO.selectBndtDiaryTotCnt", bndtManage);
    }
	...
	public BndtCeckManageVO selectBndtCeckManage(BndtCeckManageVO bndtCeckManageVO)  throws Exception {
		return (BndtCeckManageVO) selectByPk("bndtManageDAO.selectBndtCeckManage", bndtCeckManageVO);
	}
    ...
    public int selectBndtCeckManageDplctAt(BndtCeckManage bndtCeckManage) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("bndtManageDAO.selectBndtCeckManageDplctAt", bndtCeckManage);
    }
	...
	public BndtManageVO selectBndtManageBnde(BndtManageVO bndtManageVO)  throws Exception {
		return (BndtManageVO) selectByPk("bndtManageDAO.selectBndtManageBnde", bndtManageVO);
	}
    ...
    public int selectBndtManageMonthCnt(BndtManageVO bndtManageVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("bndtManageDAO.selectBndtManageMonthCnt", bndtManageVO);
    }
}
