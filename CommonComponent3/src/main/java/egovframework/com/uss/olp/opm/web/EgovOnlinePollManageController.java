...
public class EgovOnlinePollManageController {
    ...
    public String egovOnlinePollManageList(
        ...
        int totCnt = (Integer) egovOnlinePollManageService.selectOnlinePollManageListCnt(searchVO);
    ...
    public String egovOnlinePollManageDetail(
        ...
        if (sCmd.equals("del")) {
            ...
            model.addAttribute("onlinePollManage", (OnlinePollManage)egovOnlinePollManageService.selectOnlinePollManageDetail(onlinePollManage));
        }
    ...
    public String egovOnlinePollManageModify(
        ...
        if (sCmd.equals("save")) {
            ...
            //아이디 설정
            onlinePollManage.setFrstRegisterId((String)loginVO.getUniqId());
            onlinePollManage.setLastUpdusrId((String)loginVO.getUniqId());
            ...
            //게시물 정보 설정
            OnlinePollManage onlinePollManageVO = (OnlinePollManage)egovOnlinePollManageService.selectOnlinePollManageDetail(onlinePollManage);
    ...
    public String egovOnlinePollItemRegist(
        ...
        //아이디 설정
        onlinePollItem.setFrstRegisterId((String)loginVO.getUniqId());
        onlinePollItem.setLastUpdusrId((String)loginVO.getUniqId());
