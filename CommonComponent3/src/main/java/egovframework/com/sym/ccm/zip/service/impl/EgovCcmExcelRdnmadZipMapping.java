...
public class EgovCcmExcelRdnmadZipMapping extends EgovExcelMapping {
	...
	public Object mappingColumn(Row row) {
    	...
    	HSSFCell cell1 = (HSSFCell) row.getCell((int) 1);
    	HSSFCell cell2 = (HSSFCell) row.getCell((int) 2);
    	HSSFCell cell3 = (HSSFCell) row.getCell((int) 3);
    	HSSFCell cell4 = (HSSFCell) row.getCell((int) 4);
    	HSSFCell cell5 = (HSSFCell) row.getCell((int) 5);
    	HSSFCell cell6 = (HSSFCell) row.getCell((int) 6);
    	HSSFCell cell7 = (HSSFCell) row.getCell((int) 7);
    	HSSFCell cell8 = (HSSFCell) row.getCell((int) 8);
    	HSSFCell cell9 = (HSSFCell) row.getCell((int) 9);
    	HSSFCell cell10 = (HSSFCell) row.getCell((int) 10);
