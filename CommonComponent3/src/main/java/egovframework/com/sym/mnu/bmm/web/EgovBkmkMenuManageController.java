...
public class EgovBkmkMenuManageController {
    ...
    public String selectMenuList(@ModelAttribute("bkmkMenuManageVO") BkmkMenuManageVO bkmkMenuManageVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
