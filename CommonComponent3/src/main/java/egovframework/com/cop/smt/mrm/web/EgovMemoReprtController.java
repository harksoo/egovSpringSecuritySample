...
public class EgovMemoReprtController {
	...
	public String selectMemoReprt(@ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, ModelMap model) throws Exception{
		...
		if(loginVO.getUniqId().equals(memoReprt.getReportrId())){
	...
	public String updateMemoReprt(final MultipartHttpServletRequest multiRequest, @CommandMap Map commandMap, @ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		...
		if (isAuthenticated) {
			...
			****************************************************************** */
    		...
    		memoReprtVO.setLastUpdusrId(user.getUniqId());		    
	...
	public String insertMemoReprt(final MultipartHttpServletRequest multiRequest, @ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		//아이디 설정
		memoReprtVO.setFrstRegisterId((String)loginVO.getUniqId());
		memoReprtVO.setLastUpdusrId((String)loginVO.getUniqId());
