...
public class DeptJobDAO extends EgovComAbstractDAO{
	...
	public List<ChargerVO> selectChargerList(ChargerVO chargerVO) throws Exception{
		return (List<ChargerVO>) list("DeptJobDAO.selectChargerList", chargerVO);
	}
	...
	public int selectChargerListCnt(ChargerVO chargerVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectChargerListCnt", chargerVO);
	}
	...
	public List<DeptVO> selectDeptList(DeptVO deptVO) throws Exception{
		return (List<DeptVO>) list("DeptJobDAO.selectDeptList", deptVO);
	}
	...
	public int selectDeptListCnt(DeptVO deptVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectDeptListCnt", deptVO);
	}
	...
	public String selectDept(String deptVO) throws Exception{
		return (String)selectByPk("DeptJobDAO.selectDept", deptVO);
	}
	...
	public List<DeptJobBxVO> selectDeptJobBxList(DeptJobBxVO deptJobBxVO) throws Exception{
		return (List<DeptJobBxVO>) list("DeptJobDAO.selectDeptJobBxList", deptJobBxVO);
	}
	...
	public List<DeptJobBxVO> selectDeptJobBxListAll() throws Exception{
		return (List<DeptJobBxVO>) list("DeptJobDAO.selectDeptJobBxListAll", "");
	}
	...
	public int selectDeptJobBxListCnt(DeptJobBxVO deptJobBxVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectDeptJobBxListCnt", deptJobBxVO);
	}
	...
	public DeptJobBxVO selectDeptJobBx(DeptJobBxVO deptJobBxVO) throws Exception{
		return (DeptJobBxVO)selectByPk("DeptJobDAO.selectDeptJobBx", deptJobBxVO);
	}
	...
	public int selectDeptJobBxOrdr(DeptJobBxVO deptJobBxVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectDeptJobBxOrdr", deptJobBxVO);
	}
	...
	public int selectMaxDeptJobBxOrdr(String deptId) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectMaxDeptJobBxOrdr", deptId);
	}
	...
	public int selectDeptJobBxCheck(DeptJobBx deptJobBx) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectDeptJobBxCheck", deptJobBx);
	}
	...
	public List<DeptJobVO> selectDeptJobList(DeptJobVO deptJobVO) throws Exception{
		return (List<DeptJobVO>) list("DeptJobDAO.selectDeptJobList", deptJobVO);
	}
	...
	public int selectDeptJobListCnt(DeptJobVO deptJobVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("DeptJobDAO.selectDeptJobListCnt", deptJobVO);
	}
	...
	public DeptJobVO selectDeptJob(DeptJobVO deptJobVO) throws Exception{
		return (DeptJobVO)selectByPk("DeptJobDAO.selectDeptJob", deptJobVO);
	}
