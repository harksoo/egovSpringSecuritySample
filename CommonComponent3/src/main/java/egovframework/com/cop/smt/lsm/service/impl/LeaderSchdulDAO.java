...
public class LeaderSchdulDAO extends EgovComAbstractDAO {
	...
	public List<EmplyrVO> selectEmplyrList(EmplyrVO emplyrVO) throws Exception{
		return (List<EmplyrVO>) list("LeaderSchdulDAO.selectEmplyrList", emplyrVO);
	}
	...
	public int selectEmplyrListCnt(EmplyrVO emplyrVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("LeaderSchdulDAO.selectEmplyrListCnt", emplyrVO);
	}
	...
	public List<LeaderSchdulVO> selectLeaderSchdulList(LeaderSchdulVO leaderSchdulVO) throws Exception{
		return (List<LeaderSchdulVO>) list("LeaderSchdulDAO.selectLeaderSchdulList", leaderSchdulVO);
	}
	...
	public LeaderSchdulVO selectLeaderSchdul(LeaderSchdulVO leaderSchdulVO) throws Exception{
		return (LeaderSchdulVO)selectByPk("LeaderSchdulDAO.selectLeaderSchdul", leaderSchdulVO);
	}
	...
	public List<LeaderSttusVO> selectLeaderSttusList(LeaderSttusVO leaderSttusVO) throws Exception{
		return (List<LeaderSttusVO>) list("LeaderSchdulDAO.selectLeaderSttusList", leaderSttusVO);
	}
	...
	public int selectLeaderSttusListCnt(LeaderSttusVO leaderSttusVO) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("LeaderSchdulDAO.selectLeaderSttusListCnt", leaderSttusVO);
	}
	...
	public LeaderSttusVO selectLeaderSttus(LeaderSttusVO leaderSttusVO) throws Exception{
		return (LeaderSttusVO)selectByPk("LeaderSchdulDAO.selectLeaderSttus", leaderSttusVO);
	}
	...
	public int selectLeaderSttusCheck(LeaderSttus leaderSttus) throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("LeaderSchdulDAO.selectLeaderSttusCheck", leaderSttus);
	}
