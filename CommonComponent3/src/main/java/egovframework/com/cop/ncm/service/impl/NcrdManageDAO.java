...
public class NcrdManageDAO extends EgovComAbstractDAO {
	...
	return (List<NameCardVO>) list("NcrdManageDAO.selectNcrdItemList", ncrdVO);
	...
	return (List<NameCardUser>) list("NcrdManageDAO.selectNcrdUseInfs", ncrdUser);
    }
	...
	return (List<NameCardVO>) list("NcrdManageDAO.selectMyNcrdItemList", ncrdVO);
    }
