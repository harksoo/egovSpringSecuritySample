...
public class CmyBBSUseInfoManageDAO extends EgovComAbstractDAO {
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("CmyBBSUseInfoManageDAO.selectBBSUseInfsCnt", bdUseVO);
    }
	...
	return (BoardUseInfVO)selectByPk("CmyBBSUseInfoManageDAO.selectBBSUseInf", bdUseVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("CmyBBSUseInfoManageDAO.selectBBSUseInfsCntByTrget", bdUseVO);
    }
