...
public class CommunityManageDAO extends EgovComAbstractDAO {
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectCommunityInfsCnt", cmmntyVO);
    }
	...
	// 사용되지 않음
	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectCommunityUserInfsCnt", cmmntyUserVO);
    }
	...
	return (CommunityVO)selectByPk("CommunityManageDAO.selectCommunityInf", cmmntyVO);
    }
	...
	return (String)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectCmmntyTmplat", cmmntyVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.checkExistUser", cmmntyUser);
    }
	...
	return (CommunityUser)selectByPk("CommunityManageDAO.selectSingleCommunityUserInf", cmmntyUser);
    }
