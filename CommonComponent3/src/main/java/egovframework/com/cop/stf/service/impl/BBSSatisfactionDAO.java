...
public class BBSSatisfactionDAO extends EgovComAbstractDAO {
	...
	return (List<SatisfactionVO>) list("BBSSatisfactionDAO.selectSatisfactionList", satisfactionVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("BBSSatisfactionDAO.selectSatisfactionListCnt", satisfactionVO);
    }
	...
	return (Satisfaction)selectByPk("BBSSatisfactionDAO.selectSatisfaction", satisfactionVO);
    }
	...
	return (String)getSqlMapClientTemplate().queryForObject("BBSSatisfactionDAO.getSatisfactionPassword", satisfaction);
    }
	...
	return (Float)getSqlMapClientTemplate().queryForObject("BBSSatisfactionDAO.getSummary", satisfactionVO);
    }
}
