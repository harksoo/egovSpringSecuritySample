...
public class EgovAdressBookController {
    ...
    public String selectUserList(@ModelAttribute("searchVO") AdressBookUserVO adbkUserVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
