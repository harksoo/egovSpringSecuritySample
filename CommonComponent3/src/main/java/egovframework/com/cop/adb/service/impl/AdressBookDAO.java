...
public class AdressBookDAO extends EgovComAbstractDAO{
    ...
    public AdressBookVO selectAdressBook(AdressBookVO adbkVO) throws Exception {
        return (AdressBookVO)selectByPk("AdressBookDAO.selectAdressBook", adbkVO);
    }        
    ...
    public int selectAdressBookListCnt(AdressBookVO adbkVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("AdressBookDAO.selectAdressBookListCnt", adbkVO);
    }
    ...
    public int selectManListCnt(AdressBookUserVO adbkUserVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("AdressBookDAO.selectManListCnt", adbkUserVO);
    }
    ...
    public int selectCardListCnt(AdressBookUserVO adbkUserVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("AdressBookDAO.selectCardListCnt", adbkUserVO);
    }
    ...
    public AdressBookUser selectManUser(String id) throws Exception {
        return (AdressBookUser)selectByPk("AdressBookDAO.selectManUser", id);
    }
    ...
    public AdressBookUser selectCardUser(String id) throws Exception {
        return (AdressBookUser)selectByPk("AdressBookDAO.selectCardUser", id);
    }
