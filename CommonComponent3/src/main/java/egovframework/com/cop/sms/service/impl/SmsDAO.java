...
public class SmsDAO extends EgovComAbstractDAO {
	...
	return (String)insert("SmsDAO.insertSmsInf", sms);
    }
	...
	return (String)insert("SmsDAO.insertSmsRecptnInf", smsRecptn);
    }
	...
	return (SmsVO)selectByPk("SmsDAO.selectSmsInf", searchVO);
    }
	...
	return (List<SmsRecptn>) list("SmsDAO.selectSmsRecptnInfs", vo);
    }
	...
	return (String)insert("SmsDAO.updateSmsRecptnInf", smsRecptn);
    }
}
