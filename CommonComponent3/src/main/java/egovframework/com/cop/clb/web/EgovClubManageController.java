...
public class EgovClubManageController {
    ...
    public String selectClubInfByCmmntyId(@ModelAttribute("searchVO") ClubVO clubVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
    ...
    public String selectClubMainPage(@ModelAttribute("searchVO") ClubVO clubVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
    ...
    public String selectClubMainContents(@ModelAttribute("searchVO") ClubVO clubVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
    ...
    public String preivewClubMainPage(@ModelAttribute("searchVO") ClubVO clubVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
    ...
    public String previewClubMainContents(@ModelAttribute("searchVO") ClubVO clubVO, @CommandMap Map<String, Object> commandMap, ModelMap model) throws Exception {
	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	@SuppressWarnings("unused")
	Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
