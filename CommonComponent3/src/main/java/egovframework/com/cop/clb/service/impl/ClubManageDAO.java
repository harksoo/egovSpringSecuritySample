...
public class ClubManageDAO extends EgovComAbstractDAO {
	...
	return (ClubVO)selectByPk("ClubManageDAO.selectClubInf", clubVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("ClubManageDAO.selectClubInfsCnt", clubVO);
    }
	...
	// 사용되지 않음 (EgovClubManageServiceImpl.selectClubUserInfs 메소드에서 사용되나 해당 메소드가 미사용 중)
	return (Integer)getSqlMapClientTemplate().queryForObject("ClubManageDAO.selectClubUserInfsCnt", clubUserVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("ClubManageDAO.selectClubInfsCntByCmmntyId", clubVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("ClubManageDAO.checkExistUser", clubUser);
    }
	...
	return (String)getSqlMapClientTemplate().queryForObject("ClubManageDAO.selectClubTmplat", clubVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("ClubManageDAO.selectClubInfsCntByTrgetId", clubVO);
    }
	...
	return (ClubVO)selectByPk("ClubManageDAO.selectCmmntyInf", clubVO);
    }
	...
	return (ClubUser)selectByPk("ClubManageDAO.selectSingleClubUserInf", clubUser);
    }
